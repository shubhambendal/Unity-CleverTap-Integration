...
public class CleverTapUnity: MonoBehaviour {
    ...
    public String CLEVERTAP_ACCOUNT_ID = "65R-654-5Z6Z";
    public String CLEVERTAP_ACCOUNT_TOKEN = "456-256";
    ...
    void Awake(){
        ...
        //    CleverTapBinding.ResumeInAppNotifications();
            CleverTapBinding.RecordEvent("ShubUnity");
        ...
        Dictionary<string, string> newProps = new Dictionary<string, string>();
            newProps.Add("email", "shub1@unity.com");
            newProps.Add("Identity", "455123");
        CleverTapBinding.OnUserLogin(newProps);
        CleverTapBinding.CreateNotificationChannel("245", "245", "CT test channel", 5, true);
